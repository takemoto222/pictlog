          ...
          <div class="controller">
            ...
            <div class="slide">
              ...
              <form action="/item_scr/{{ $photo->image }}" method="get">
                ...
                <ul>
                  @isset($photo->image)
                  <li><img src="storage/image/{{($photo->image)}}" value="{{$photo->image}}" name="image" alt="画像" class="slide_img_first" multiple /></li>
                  <li><img src="storage/image/{{($photo->image2)}}" value="{{$photo->image2}}" name="image2" alt="画像" class="slide_img_list" multiple /></li>
